...
//while and do-while loops are different as do-while loops evalute the condition after the statements are executed but while statements do it before
...
public class DoWhileSwimming
{
	public static void main( String[] args ) throws Exception
	{
		...
		//Gallant and Goofus swim for the same amount of time at 80.5 degrees
		//If temperature changes to 78, Gallant does not swim, while goofus does but only for one minute(do while statement for goofus executed at least once)
		//Gallant checks the temperature first, while Goofus dives right in
